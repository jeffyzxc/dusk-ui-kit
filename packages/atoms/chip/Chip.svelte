...
<div
  class="{$$props.class || ''} duk-chip"
  class:duk-chip--brand="{variant === variants.CHIP.BRAND}"
  class:duk-chip--cta="{variant === variants.CHIP.CTA}"
  class:duk-chip--info="{variant === variants.CHIP.INFO}"
