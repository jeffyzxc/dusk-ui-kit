<script>
  ...
  import { forwardEventsBuilder, exclude, contexts, variants } from "@dusk-network/helpers";
  import "./styles.css";
  import { A, Div } from "@dusk-network/elements";
  ...
  function getClassNames(variant, context) {
    ...
    switch (variant) {
      case variants.ATOM.LOGO.BRAND:
        ...
        break;
      case variants.ATOM.LOGO.CTA:
        classNames += " duk-logo--cta";
        break;
...
<svelte:component
  ...
  <svg id="__DUK_LOGO" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 291.36 63.27">
    ...
    <polygon
      points="263.18 29.17 289.86 5.17 282.16 5.17 256.97 28.94 256.9 28.94 256.9 5.17 251.52 5.17
      251.52 58.1 256.9 58.1 256.9 29.91 256.97 29.91 283.44 58.1 291.36 58.1 263.18 29.17"></polygon>
  </svg>
</svelte:component>
